...
export function Sidebar({ alertCount = 0 }: SidebarProps) {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-[var(--bg-secondary)] border-r border-[var(--border-primary)] flex flex-col z-50">
      {/* Logo / Brand */}
      <div className="p-4 border-b border-[var(--border-primary)]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-[var(--text-primary)] tracking-wide">
              HYDRO-MON
            </h1>
